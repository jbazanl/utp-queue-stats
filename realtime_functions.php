...
function agent_name($channel) {
	...
	//if(is_file("agents.txt")) {
        ...
        ///mnt/var/www/html/queue-stats/realtime_functions.php
         if(is_file("/mnt/var/www/html/queue-stats/agents.txt")) {
         $lineas = file("/mnt/var/www/html/queue-stats/agents.txt");
